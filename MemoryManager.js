...
*
* @property memory Where each scope is stored.
* @method newBlock Creates a new block of memory which is separate from any other scope. Overwrites 
...
* @method setData Sets data to a given variable in a given block. Overwrites any data already set.
*			@param ref The block identifier.
*			@param key The variable name.
*			@param value The data to set.
*			@return A boolean value as to whether the data was set.
* @method delData Remove the given key and the data it's associated with.
*			@param ref The block identifier.
*			@param key The variable name to delete.
*			@return A boolean as to whether the data has been deleted.
* @method getData Retrieve the data associated with the given key, if any.
*			@param ref The block identifier.
...
* @method hasData Check if the given key name exists.
*			@param ref The block identifier.
*			@param key The variable name to check.
*			@return A boolean representing whether the key name exists.
* @method isBlock Check if the given reference refers to a valid block in memory
*			@param ref The block identifier.
*			@return A boolean representing whether a block with the given identifier exists.
* @method blockRef Return a reference to the full block, allowing native manipulation. Useful when
